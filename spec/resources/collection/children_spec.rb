  ...
  context "existing children" do
    ...
    context "collection-media-entry-arcs" do
      ...
      it 'links for a round trip "collection → arc → entry → arc → collection" ' \
        ...
        media_entry_resource = json_roa_keyword_resource.get.relation("collection-media-entry-arcs").get.collection.first.get.relation("media-entry").get
        collection_resource = media_entry_resource.relation("collection-media-entry-arcs").get.collection.first.get.relation("collection").get
