        ...
        describe "authenticated_json_roa_client" do
          ...
          describe "with random public view permission" do
            ...
            describe "the meta-datum resource" do
              let :resource do
                authenticated_json_roa_client.get.relation("meta-datum").get("id" => meta_datum_json.id)
              end
            ...
            describe "the meta-datum-data-stream resource" do
              let :resource do
                authenticated_json_roa_client.get.relation("meta-datum-data-stream").get("id" => meta_datum_json.id) do |conn|
