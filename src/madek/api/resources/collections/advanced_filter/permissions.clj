...
(defn filter-by-query-params [sqlmap query-params authenticated-entity]
  ...
  (cond-> sqlmap
    (:public_get_metadata_and_previews
      query-params) (sql/merge-where
                      [:= :collections.get_metadata_and_previews true])
    (= (:me_get_metadata_and_previews query-params)
       true) (filter-by-permission-for-auth-entity
